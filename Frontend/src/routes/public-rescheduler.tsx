          ...
          <CardContent className="space-y-5 p-6">
              ...
              <Form method="post" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    required
                    disabled={!hasSelectableAppointment || isSubmitting}
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                  Confirming will book the earlier free slot and cancel the selected old appointment.
                </div>
            ...
            {offer.responseDeadlineAt ? (
              <div className="flex items-center gap-2 text-sm text-slate-500">
                ...
                Please respond before {formatDateTime(offer.responseDeadlineAt)}.
              </div>
            ) : null}
          </CardContent>
        </Card>
