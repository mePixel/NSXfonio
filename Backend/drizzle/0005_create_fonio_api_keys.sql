...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "fonio_api_keys_client_id_idx" ON "fonio_api_keys" USING btree ("client_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "fonio_api_keys_revoked_at_idx" ON "fonio_api_keys" USING btree ("revoked_at");
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "fonio_api_keys_client_active_idx" ON "fonio_api_keys" USING btree ("client_id") WHERE "revoked_at" is null;
